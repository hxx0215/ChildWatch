...
//刻度距离文字的距离
static const CGFloat imageSpaceToLable=2;

//显示刻度的lable的字体大小
static const CGFloat rulerLableFont=8;
...
-(void)setUpRuleImageView{
    ...
    for (NSInteger i=0; i<=BTminus(_maxNuber,_mixNuber)/_rulerMultiple ; i++) {
        ...
        rulerImageView.tag=(_showType==rulerViewshowHorizontalType)?i:BTminus(_maxNuber,_mixNuber)/_rulerMultiple-i;
        ...
        rulerLable.textColor=[UIColor darkGrayColor];//ZHColor(255, 255, 255);
